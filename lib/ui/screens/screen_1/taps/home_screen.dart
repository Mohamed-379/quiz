  ...
  List<Widget> slide = [
    ...
    child: const Row(
      ...
      children: [
        Expanded(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  ImageIcon(AssetImage(AppAssets.start)),
                  SizedBox(width: 6),
                  Text("10 mins")
                ],
              )
        ...
        Expanded(flex: 2,child: Image(image: AssetImage(AppAssets.walk),width: 80,height: 80,))
      ],
          ...
          children: [
            const Row(
              children: [
                ...
                Spacer(),
                Badge(child: Image(image: AssetImage(AppAssets.noti)))
              ],
            ),
            ...
            const Row(
              ...
              children: [
                ...
                Column(
                  children: [
                    Image(image: AssetImage(AppAssets.cool)),
                    Text("Cool")
                  ],
                ),
                Column(
                  children: [
                    Image(image: AssetImage(AppAssets.happy)),
                    Text("Happy")
                  ],
                ),
                Column(
                  children: [
                    Image(image: AssetImage(AppAssets.sad)),
                    Text("Sad")
                  ],
                )
              ],
            ...
            const Row(
              children: [
                ...
                Image(image: AssetImage(AppAssets.back)),
              ],
            ),
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  child: const Row(
                    children: [
                      Image(image: AssetImage(AppAssets.relax)),
                      SizedBox(width: 8,),
                      Text("Relaxation",
                 ...
                 Container(
                   ...
                   child: const Row(
                    children: [
                      Image(image: AssetImage(AppAssets.m)),
                      SizedBox(width: 8,),
                      Text("Meditation",
                        style: TextStyle(fontSize: 18),
                      )
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  child: const Row(
                    children: [
                      Image(image: AssetImage(AppAssets.b)),
                      SizedBox(width: 8,),
                      Text("Breathing",
                        style: TextStyle(fontSize: 18),
                      )
                ...
                Container(
                  ...
                  child: const Row(
                    children: [
                      Image(image: AssetImage(AppAssets.yoga)),
                      Text("Yoga           ",
                        style: TextStyle(fontSize: 18),
                      )
                    ],
